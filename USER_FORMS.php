...
<div class="banner">`
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">USER DETAILS</button>
        </li>
        <li class="nav-item" role="presentation">
        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">FIR</button>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <center>
        ...
        <form action="FIR_DETAILS.php" id="firform" name="firform"  method="post" onsubmit="return regFir()">
            <div data-aos="zoom-in" data-aos-delay="150" class="inputBox1">
            
        <tr>
                <td><span class="form">User Id</span></td>
                <td><h2><BR><BR><?php echo $_SESSION['userid'];?></h2><input type="hidden" class="firstname" name="user_id" id="user_id" value="<?php echo $_SESSION['userid'];?>">
        ...
        <br><br><br><input data-aos="fade-up" data-aos-delay="600" class="btn1" type="submit" name="btn_submit" id="submit">
...
<!-- Fir Form section ends -->
    ...
    <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
        <!-- Fir Details Start-->
        <form action="FIR_DETAILS.php" method="post" style="font-size:20px;">
            User Id:
            <span><?php echo $_SESSION['userid'];?></span><input type="hidden" class="firstname" name="user_id" id="user_id" value="<?php echo $_SESSION['userid'];?>">
            <br>
            <input data-aos="fade-up" data-aos-delay="600" class="btn1" type="submit" name="details" id="submit">
        </form>
